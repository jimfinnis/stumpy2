...
public class Controller {
     ...
     */
    public Controller(String name, JFrame alertFrame, Controller fallback){
    	this.name = name;
     ...
     * Default constructor
     */
    public Controller(String name,JFrame f){
        this(name,f,null);
    }
    ...
    public boolean handle(String command) throws Exception{
        ...
        System.out.println("HANDLE:"+name+"/"+command);
        if(null==r || !r.enabled()){
        	if(r==null)System.out.println("  Command not found");
        	else System.out.println("  Command not enabled");
            if(null!=fallback){
